...
> [!NOTE]  
> This is the `intro` branch, meant to only contain documentation and text.  
> Source code can be found in the appropriate branches.  

This is a simple multiloader mod (only a single mixin) that allows resource packs to be contained inside of [symbolic links](https://en.wikipedia.org/wiki/Symbolic_link) to be loaded.  
